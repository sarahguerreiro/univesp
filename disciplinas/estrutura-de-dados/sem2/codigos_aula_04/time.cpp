...
int Time::getHour() const {
  return hour; // quando vc tem metodos q nao vao alterar os atributos, é indicado o uso do const q garante nao ser possivel mudar os atributos
}
...
void Time::setHour(int hour) {
  this->hour = hour; // como nos setters o objetivo é justamente fazer algumas atribuições já n se torna necessario  o uso do const apos o metodo; aqui, passamos o parametro a ser recebido.
}
